...
echo "***********************************"
virtualenv flask-cassandra --no-site-packages
...
echo "***********************************"
source flask-cassandra/bin/activate
...
echo "***********************************"
pip install -r requirements-server-cassandra.txt
...
python start_server_cassandra.py

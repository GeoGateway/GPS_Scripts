/* NR_CAUTION: This is the ANSI NR_C (only) version of the Numerical Recipes
   ...
   *That* file is the one from the book, and contains both ANSI and
   ...
   correct version.  *This* file contains only ANSI NR_C.               */
...
#ifndef lint
static char nr_complex_hdr_rcsid[] = "$Id: complex.h,v 1.1 1996/07/25 17:26:54 agray Exp $";
#endif
/* 
 * $Log: complex.h,v $
